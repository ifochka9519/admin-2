...
<section id="work-section" class="container">
    <div class="row">
        @foreach($jobs as $job)
        <article class="col-lg-4 col-md-4 col-sm-6">
            <div class="work-block">
                <img src="{{$job->way}}" class="img-responsive" alt="{{$job->description}}">
                <h3>
                    {{$job->title}}
                </h3>
                <h4>
                    Зарплата от {{$job->money}} грн
                </h4>
...
<section id="banner-work-section">
    <div class="banner-work-img-wrapper">
        <div class="banner-work-img-wrapper-text">
            <h3>
                БЕСПЛАТНАЯ КОНСУЛЬТАЦИЯ ПО РАБОТЕ В ПОЛЬШЕ
            </h3>
            <p>
                Если Вы еще не определились, на какой вакансии хотите работать, <br>
                наши специалисты помогут Вам с индивидуальным подбором вакансии
                в Польше.
            </p>
            <a class="banner-work-section-button" href="">
                Заказать звонок
            </a>
        </div>
        <img src="img/work_page/15.jpg" class="img-responsive" alt="">
    </div>
</section>
