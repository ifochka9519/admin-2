...
{!! Form::open(array('files' => true, 'route' => config('quickadmin.route').'.job.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('money', old('money'), array('class'=>'form-control')) !!}
