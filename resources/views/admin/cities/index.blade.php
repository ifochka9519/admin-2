...
<p>{!! link_to_route(config('quickadmin.route').'.cities.create', 'Добавить новый' , null, array('class' => 'btn btn-success')) !!}</p>
                ...
                <tbody>
                    @foreach ($cities as $row)
                        <tr>
                            ...
                            <td>
                                {!! link_to_route(config('quickadmin.route').'.cities.edit', 'Редактировать', array($row->id), array('class' => 'btn btn-xs btn-info')) !!}
