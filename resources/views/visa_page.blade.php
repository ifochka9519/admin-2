...
<div class="container-fluid">
    ...
    <section id="header-section-menu" class="row">
        ...
        <article id="header-section-menu-orange-border" class="col-lg-10 col-md-10 col-sm-10">
            <ul>
...
<section id="description-section" class="container">
    <article class="visa-country">
        <div class="visa-img-wrapper">
            <p class="visa-img-wrapper-text" href="">
                Польша
            </p>
            <img src="img/visa_page/1.jpg" class="img-responsive" alt="">
        </div>
        <h2>
            Lorem ipsum dolor sit amet
        </h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam
            adipisci rerum consequuntur cum, quae, nemo laboriosam quibusdam,
            nihil atque dolorum quasi. Debitis quibusdam odit, inventore illo iusto
            in. Explicabo, aperiam?
        </p>
        <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Maiores, earum autem inventore sit repellat repellendus sequi,
            soluta eligendi incidunt mollitia vel facere ab fuga voluptate
            eaque tenetur voluptatem pariatur explicabo!
        </p>
    ...
    <article class="visa-country">
        <div class="visa-img-wrapper">
            ...
            <img src="img/visa_page/3.jpg" class="img-responsive" alt="">
        </div>
        <h2>
            Lorem ipsum dolor sit amet
        </h2>
        ...
        <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Molestias praesentium, sequi at corrupti id facere quidem ratione.
            Iusto ullam at molestias totam? Quos explicabo harum accusamus porro
            at, quisquam fugit.
        </p>
        <a href="" class="visa-country-botton">
            Узнать больше
    ...
    <article class="visa-country">
        <div class="visa-img-wrapper">
            ...
            <img src="img/visa_page/3.png" class="img-responsive" alt="">
        </div>
        <h2>
            Lorem ipsum dolor sit amet
        </h2>
        ...
        <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Tempora sint nostrum reiciendis, repellat expedita voluptatem
            excepturi veniam minima deserunt a ab pariatur ipsum non incidunt
            consequuntur facilis maiores, id perferendis.
        </p>
        <a href="" class="visa-country-botton">
            Узнать больше
        </a>
...
<section id="banner-visa-section">
    <div class="banner-visa-img-wrapper">
        <div class="banner-visa-img-wrapper-text">
            <h3>
                ПОДБОР ВИЗЫ ПОД ВАШИ ПЛАНЫ
            </h3>
            <p>
                Наши специалисты сделают подбор визы под Ваш маршрут или Ваши цели, <br>
                учитывая все требования. Для этого Вам просто нужно заказать звонок.
            </p>
            <a class="banner-visa-section-button" href="">
                Заказать звонок
            </a>
        </div>

        <img src="img/visa_page/8.jpg" class="img-responsive" alt="">
    </div>
</section>
